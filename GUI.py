...
class MainWindow(QWidget):
    def __init__(self):
        ...
        self.EmpName   = QLabel()
        self.EmpName.setText("ttaetaegagww")
        self.VBL.addWidget(self.FeedLabel)
        self.VBL.addWidget(self.EmpName)
    ...
    def run(self):
        ...
        while self.ThreadActive:
            try:
                ...
                Pic = ConvertToQtFormat.scaled(720, 720, Qt.KeepAspectRatio)
               ...
               # fps = 1/(endtimer-timer)
                ...
                if FakeFlage==True :   
                    ...
                    cv2.putText(Image, "NoFace", (x,y - 10),cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0,255,0), 2)
